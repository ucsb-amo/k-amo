...
class Potassium39(arc.Potassium39):
    ...
    def get_zeeman_shift(l,j,f,m_f,B):
        '''
        Returns the zeeman shift in units of MHz as a function of B field (in Gauss) for a given F, m_f sublevel in the specified fine structure manifold
